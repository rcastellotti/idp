...
We plan to fuzz the dish interal GRPC dishy api to see if we manage to get access to internal statistics.
 We will probably reverse engineer the Android application provided to manage the dish to see if we can find some hidden endpoints.
Eventually we will develop some tooling to facilitate the usage of the API, furthermore we will develop a tool to compare
the measurements provided by the API with the measurements we make.
