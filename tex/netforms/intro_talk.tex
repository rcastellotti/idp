...
anywhere in the world. We aim to understand in internal routing decisions, general behavior for handling incoming packets and to
...
Eventually we will develop a toolset to interact with the API, in order to abstract some of the logic to make it easier to perform managements. 
...
We found some research regarding measurements~\cite{10.1145/3517745.3561416, 10.1145/3517745.3561457}, in the latter study a consistent loss of packages correlated with satellite handovers was observed, they are only suggesting a correlation, we will try to provide some insights regarding the impact of satellite handovers in latency increases.
