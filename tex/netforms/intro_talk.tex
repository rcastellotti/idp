...
There is not much literature about internals of the dish and about the API, there's an interesting hardware-level hacking talk given at DEFCON \cite{defcon}, they managed to get a shell on the dishy, however this hardware-level research won't be part of our research.
